...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      class_activity: {
        Row: {
          activity_type: Database["public"]["Enums"]["class_activity_type"]
          class_id: string
          created_at: string
          details: Json | null
          id: string
        ...
        Relationships: [
          {
            foreignKeyName: "class_activity_class_id_fkey"
            columns: ["class_id"]
            isOneToOne: false
            referencedRelation: "classes"
            referencedColumns: ["class_id"]
          ...
          {
            foreignKeyName: "class_activity_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
      ...
      folders: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "folders_class_id_fkey"
            columns: ["class_id"]
            isOneToOne: false
            referencedRelation: "classes"
            referencedColumns: ["class_id"]
    ...
    Functions: {
      ...
      log_class_activity: {
        Args: {
          p_activity_type: Database["public"]["Enums"]["class_activity_type"]
          p_class_id: string
          p_details: Json
          p_user_id: string
        }
