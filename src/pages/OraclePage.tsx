...
import { ConfirmationDialog } from '@/components/ui/ConfirmationDialog'; // Import the new component
      ...
      <MainAppLayout pageTitle="Oracle | Eido AI">
        <TooltipProvider delayDuration={100}>
          <div className="flex-1 w-full bg-mushroom-100 flex flex-col relative" onPaste={handlePaste}>
            ...
            {/* CORRECTED: Replaced AlertDialog with the new ConfirmationDialog component */}
            <ConfirmationDialog
