...
const PolicyCenter = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold mb-2 text-cybercoach-blue-dark">Policy Center</h1>
        <p className="text-gray-600 mb-6">
          Here's a quick guide to our core cybersecurity policies. Use this as a reference to stay compliant and secure.
        </p>
